...
p('Zpětně zpracované vydání k 1. září 2026 s doplněním metodické rady ze 17. září. Termíny před 17. zářím jsou uvedeny pro úplnost zářijového přehledu.','SmallText')
...
p('Zdroj: příspěvek Metodické rady ČASPV ze 17. září 2026 a odkazované propozice akcí.','SmallText')
story.append(PageBreak())
...
p('Sdělení České asociace Sport pro všechny - září 2026. Zpracováno 17. září 2026 jako zpětné zářijové vydání. Přehled vychází z usnesení valné hromady, oficiálních pozvánek a příspěvku metodické rady. Zdroje a přihlášky jsou dostupné prostřednictvím odkazů v textu. Kontaktní a servisní informace byly ověřeny k datu zpracování.','SmallText')
story.append(PageBreak())
